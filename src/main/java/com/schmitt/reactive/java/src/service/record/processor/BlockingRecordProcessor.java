...
public interface  BlockingRecordProcessor<P, R, T> {
     ...
     * }
     */
    Map<T, Map<UUID, Long>> processRecords(Mono<List<P>> recordsToProcess);

    R produceResult(int numberOfRecordsToProduce, int numberOfCharactersPerRecord);
