...
public class ParentV2 extends Person implements Serializable {
    private static final String THIS_FIELDS = Arrays.stream(ParentV2.class.getDeclaredFields())
    ...
    public ParentV2(@NonNull String name, int age) {
        super(name, age);
    }
    ...
    public Optional<String> getDogName() {
        return Optional.ofNullable(dogName);
    }
}
