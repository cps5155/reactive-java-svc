 ...
 */
public class MonoCharNonBlockingRecordProcessor extends CharNonBlockingRecordProcessor {
    public MonoCharNonBlockingRecordProcessor(Random randomGenerator) {
